<template>
    <div id = "banner">
        ...
        <div id="nav">
            ...
            <div id="pages" >
                <router-link :to="{ name: 'home' }" class="btn btn-light banner_button page" :class="{ disabled_item: state.list_loading }" :tabindex=banner_tab_index>Home</router-link> 
                <router-link :to="{ name: 'about' }" class="btn btn-light banner_button page" :class="{ disabled_item: state.list_loading }" :tabindex=banner_tab_index >About</router-link>
            </div>
        </div>

        <div id="banner_form">
            <div id="banner_input_and_button">
                <input @keydown.enter="input_submit" placeholder="City name" class="form-control" :class="{ disabled_item: state.list_loading }" id="input_form" v-model="input_value" :tabindex=banner_tab_index>

                <button class="btn btn-light banner_button" :class="{ disabled_item: state.list_loading }" id="input_button" @keydown.enter="input_submit" @click="input_submit" :tabindex=banner_tab_index><strong>Search For Buddy</strong></button>
            </div>
            <p v-if="state.list_loading" id="list_loading"><i>The cities list is loading, please wait...</i></p>
        </div>
